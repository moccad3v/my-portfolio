...
const aboutme = ({ clicks, setClicks, texts }) => {
  return (
    ...
    >
      ...
      <p className="text-lg max-w-4xl text-[#001011] montserrat-light-font">
        {texts.aboutme.description}
      </p>

      <button
        onClick={() => setClicks(clicks + 1)}
        className="montserrat-regular-font mt-10 px-6 py-3 bg-gradient-to-r from-blue-700 to-[#004aad] text-white font-bold rounded-lg shadow-lg transition-transform transform hover:scale-105"
      >
